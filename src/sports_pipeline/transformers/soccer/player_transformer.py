        ...
        silver = pd.DataFrame(
            {
                ...
                "minutes": pd.to_numeric(df.get("minutes", 0), errors="coerce")
                .fillna(0)
                .astype(int),
                "goals": pd.to_numeric(df.get("goals", 0), errors="coerce").fillna(0).astype(int),
                "assists": pd.to_numeric(df.get("assists", 0), errors="coerce")
                .fillna(0)
                .astype(int),
                ...
                "shots_on_target": pd.to_numeric(df.get("shots_on_target", 0), errors="coerce")
                .fillna(0)
                .astype(int),
                "key_passes": pd.to_numeric(df.get("key_passes", 0), errors="coerce")
                .fillna(0)
                .astype(int),
                "tackles": pd.to_numeric(df.get("tackles", 0), errors="coerce")
                .fillna(0)
                .astype(int),
